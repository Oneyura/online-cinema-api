...
class S3FileUploadError(BaseS3Error):
    ...
    def __init__(self, message: str = "Failed to upload file to S3 storage") -> None:
        super().__init__(message)
...
class S3FileNotFoundError(BaseS3Error):
    ...
    def __init__(self, message: str = "File not found in S3 storage") -> None:
        super().__init__(message)
...
class S3PermissionError(BaseS3Error):
    ...
    def __init__(self, message: str = "Permission denied for S3 storage operation") -> None:
        super().__init__(message)
