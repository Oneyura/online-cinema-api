...
class BaseAppSettings(BaseSettings):
    ...
    MINIO_BUCKET_NAME: str = os.getenv("MINIO_BUCKET", "cinema-storage")
...
class Settings(BaseAppSettings):
    model_config = SettingsConfigDict(env_file=(".env", ".env.local"), env_file_encoding="utf-8", extra="allow")
...
class ProductionSettings(BaseAppSettings):
    ...
    model_config = SettingsConfigDict(env_file=(".env.prod",), env_file_encoding="utf-8", extra="allow")
